# TASK014 — Migrate Rust-Backend Recipes to SDK `connect`

## Context

Depends on: TASK006 (rust connect) + frontend SDK connect tasks.
...
| `rust-swift-holons` | `rust-holons` | `swift-holons` | TASK007 |
| `rust-kotlin-holons` | `rust-holons` | `kotlin-holons` | done (kotlin connect exists) |
| `rust-web-holons` | `rust-holons` | `js-web-holons` | TASK008 |
| `rust-dotnet-holons` | `rust-holons` | `csharp-holons` | done (csharp connect exists) |
| `rust-qt-holons` | `rust-holons` | `cpp-holons` | TASK011 |
