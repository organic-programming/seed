...
|---|---|---|---|
| 01 | [TASK01](./grace-op_v0.6_TASK01_rest_sse_go.md) | REST + SSE in `go-holons` (reference) | — |
...
| 04 | [TASK04](./grace-op_v0.6_TASK04_rest_sse_dart.md) | REST + SSE in `dart-holons` | TASK01, TASK02 |
| 05 | [TASK05](./grace-op_v0.6_TASK05_rest_sse_swift.md) | REST + SSE in `swift-holons` | TASK01, TASK02 |
| 06 | [TASK06](./grace-op_v0.6_TASK06_rest_sse_kotlin.md) | REST + SSE in `kotlin-holons` | TASK01, TASK02 |
