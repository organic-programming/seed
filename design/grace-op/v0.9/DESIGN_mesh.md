...
For the `public` mode (exposing a holon to external consumers with per-consumer confidentiality), see [DESIGN_public_holons.md](../v0.10/DESIGN_public_holons.md).
