...
- [DESIGN_native_hostui_expansion.md](./v0.4.5/DESIGN_native_hostui_expansion.md) — C++, C, Java HostUI assemblies
...
- [v0.4/](./v0.4/_TASKS.md) — Recipe Ecosystem (6 tasks)
  ...
  - [v0.4.5/](./v0.4.5/_TASKS.md) — Native Expansion (5 tasks: 24 assemblies + 3 C compositions + doc updates)
