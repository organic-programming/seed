...
public final class Relay extends com.google.protobuf.GeneratedFile {
  private Relay() {}
  static {
  ...
  public interface TickResponseOrBuilder extends
    ...
    /**
     * <code>string responder_slug = 1;</code>
    ...
    /**
     * <code>string responder_instance_uid = 2;</code>
    ...
    /**
     * <code>repeated .relay.v1.HopReceipt hops = 3;</code>
     */
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(responderInstanceUid_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, responderInstanceUid_);
          ...
          {
            final int count = hops_.size();
            for (int i = 0; i < count; i++) {
              size += com.google.protobuf.CodedOutputStream
                .computeMessageSizeNoTag(hops_.get(i));
            }
            size += 1 * count;
          }
      size += getUnknownFields().getSerializedSize();
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\010received\030\003 \001(\003\"j\n\014TickResponse\022\026\n\016resp" +
      "onder_slug\030\001 \001(\t\022\036\n\026responder_instance_u" +
      "id\030\002 \001(\t\022\"\n\004hops\030\003 \003(\0132\024.relay.v1.HopRec" +
      "eipt2E\n\014RelayService\0225\n\004Tick\022\025.relay.v1." +
      "TickRequest\032\026.relay.v1.TickResponseB1Z/e" +
      "xamples/relay-cascade/_protos/relay/v1;r" +
      "elayv1b\006proto3"
    };
