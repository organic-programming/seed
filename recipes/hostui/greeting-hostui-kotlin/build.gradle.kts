...
val packagedDaemonBinaryName = "gudule-greeting-daemon"
val devDaemonBinaryName = "gudule-daemon-greeting-go"
...
val stageDaemon by tasks.registering(Copy::class) {
    from(layout.projectDirectory.dir("../../daemons/greeting-daemon-go/.op/build/bin")) {
        include(devDaemonBinaryName)
        rename { packagedDaemonBinaryName }
    }
    from(layout.projectDirectory.dir("../../daemons/greeting-daemon-go")) {
        include(devDaemonBinaryName)
        rename { packagedDaemonBinaryName }
    }
