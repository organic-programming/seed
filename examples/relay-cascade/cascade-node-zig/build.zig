...
const app_generated_c_sources = [_][]const u8{
...
fn holonsModule(
    ...
    mod.addCSourceFiles(.{
        ...
        .files = &sdk_generated_c_sources,
        .flags = &.{ "-std=c99", "-Wno-unused-parameter", "-fno-sanitize=undefined" },
    });
    mod.addCSourceFiles(.{
        .root = b.path("gen/c"),
        .files = &app_generated_c_sources,
        .flags = &.{ "-std=c99", "-Wno-unused-parameter", "-fno-sanitize=undefined" },
    });
...
pub fn build(b: *std.Build) void {
    ...
    const test_step = b.step("test", "Run cascade-node-zig tests");
