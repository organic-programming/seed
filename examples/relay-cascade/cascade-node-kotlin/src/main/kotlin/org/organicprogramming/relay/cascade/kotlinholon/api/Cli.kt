...
import org.organicprogramming.relay.cascade.kotlinholon.internal.RelayServer
import relay.v1.Relay
import java.io.PrintStream

object Cli {
    const val VERSION = "cascade-node-kotlin {{ .Version }}"
    ...
    private fun printUsage(output: PrintStream) {
        output.println("usage: cascade-node-kotlin <command> [args] [flags]")
        output.println()
