...
import org.organicprogramming.relay.cascade.javaholon.internal.RelayServer;
...
public final class Cli {
    public static final String VERSION = "cascade-node-java {{ .Version }}";
    ...
    static void printUsage(PrintStream output) {
        output.println("usage: cascade-node-java <command> [args] [flags]");
        output.println();
