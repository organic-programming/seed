...
const relay_gen_root = "../cascade-node-zig/gen/c";
...
pub fn build(b: *std.Build) void {
    ...
    const exe = b.addExecutable(.{ .name = "relay-cascade-zig", .root_module = app_mod });
    ...
    const test_step = b.step("test", "Run relay-cascade-zig tests");
