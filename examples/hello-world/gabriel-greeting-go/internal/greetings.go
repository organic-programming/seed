...
type Greeting struct {
	...
	LangEnglish string // English lang name
	LangNative  string // Native script name
	Template    string // fmt.Sprintf template with one %s for the name
	DefaultName string // The default subject for example "Marie"
}
